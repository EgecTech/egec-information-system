...
export default function Shop({
  ...
  const [afilink, setAfilink] = useState(exisitngAfilink || []);
  ...
  async function createProduct(ev) {
    ...
    if (!title || !slug || !description || !afilink || !status) {
  ...
  return (
    <>
      ...
      >
        ...
        <div className="flex flex-col items-start mb-4">
          <label htmlFor="price" className="text-gray-800 font-semibold w-full">
            Price
          </label>
          <input
            type="text"
